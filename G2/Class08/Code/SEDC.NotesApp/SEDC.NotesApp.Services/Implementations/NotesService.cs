...
namespace SEDC.NotesApp.Services.Implementations
{
    public class NotesService : INotesService
    {
        ...
        public NotesService(IRepository<Note> notesRepository, IRepository<User> usersRepository)
        {
        ...
        public void DeleteNote(int id)
        {
            ...
            if(noteDb == null)
            {
                throw new ResourceNotFoundException(id, $"Note with {id} was not found!");
            }
        ...
        public NoteDto GetNoteById(int id)
        {
            ...
            {
                //log
                throw new ResourceNotFoundException(id, $"Note with id {id} was not found");
            }
        ...
        public void UpdateNote(AddUpdateNoteDto updateNoteDto)
        {
            ...
            if(noteDb == null)
            {
                throw new ResourceNotFoundException(updateNoteDto.Id, $"Note with id {updateNoteDto.Id} was not found");
            }
